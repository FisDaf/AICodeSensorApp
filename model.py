...
class CodeSensorModel:
    ...
    def highlight_code(self, code_text: str) -> str:
        """Возвращает HTML с подсветкой синтаксиса Python"""
    ...
    def analyze(self, code_text: str) -> tuple[int, str]:
        ...
        if verdict == 1:
            ...
            highlighted = self.highlight_code(code_text)
            html_result = (
                f"<h2 style='color: green;'>Файл безопасен</h2>"
            )
            html_result += highlighted
